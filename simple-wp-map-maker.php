 ...
 *
 * @link              https://github.com/2braincells2go/
 * @since             1.3
 * @package           simple-wp-map-maker-map
 *
 * @wordpress-plugin
 * Plugin Name:       Simple WP Maker Map
 * Plugin URI:        https://github.com/2braincells2go/simplemaps/
 * Description:       Create map in the selected direction with a marker with text and link.
 * Version:           1.3
 * Author:            QikSoft
 * Author URI:        https://qiksoft.com
 * License:           GPL-3.0+
 * License URI:       http://www.gnu.org/licenses/gpl-3.0.txt
 * Text Domain:       simple-wp-map-maker-map
...
add_action('plugins_loaded', 'simple_wp_map_maker_menu');
...
function vswpmm_add_languages() {
	load_plugin_textdomain( 'simple-wp-map-maker-map', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
}
